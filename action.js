...
const translations = {
    id: {
        ...
        address: "<i class=\"fa-solid fa-location-dot\"></i> Tangerang Selatan",
...
function updateContent(lang) {
    ...
    document.querySelector('.contact-item').innerHTML = content.address;
    ...
    if (lang === 'en') {
        ...
        if (collegeItems[0]) {
            ...
            collegeItems[0].querySelector('#thesis-link').innerHTML = '<i class="fa-solid fa-file-lines"></i> My Thesis';
        }
        ...
        if (collegeItems[0]) {
            ...
            collegeItems[0].querySelector('#thesis-link').innerHTML = '<i class="fa-solid fa-file-lines"></i> Skripsi Saya';
        }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.experience-item').forEach(item => {
            ...
            item.addEventListener('mousedown', (e) => {
                // Hanya aktif jika bukan tombol/link di dalamnya
    ...
    ['.contact-item', '.btn-secondary'].forEach(selector => {
